...
private val TransitPresentations = TransitType.entries.associateWith { type ->
    val color = when (type) {
...
private val SelectedTransitPointStyle = pointStyle {
...
private val SelectedTransitLabelStyle = smallLabelStyle {
    color(0xFF111827)
    noHalo()
    background(
        color = 0xFFFFD54F,
