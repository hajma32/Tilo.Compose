...
data class TileGrid(
    ...
    fun zoomForViewport(
        ...
        val normalizedWorldWidthPixels = normalizedWorldWidth * viewport.pixelRatio
        val targetTileSizePixels = targetTileSizeDip * viewport.pixelRatio
        return (mapZoom + log2(normalizedWorldWidthPixels / targetTileSizePixels))
            .roundToInt()
            .coerceIn(0, 22)
    }
    ...
    private fun tileRange(
        ...
        val x0 =
            kotlin.math
                .floor((minX - originX) / span)
                .toInt()
                .coerceIn(0, nx - 1)
        val x1 =
            kotlin.math
                .floor((maxX - originX - epsilon) / span)
                .toInt()
                .coerceIn(0, nx - 1)
        val y0 =
            kotlin.math
                .floor((originY - maxY) / span)
                .toInt()
                .coerceIn(0, ny - 1)
        val y1 =
            kotlin.math
                .floor((originY - minY - epsilon) / span)
                .toInt()
                .coerceIn(0, ny - 1)
